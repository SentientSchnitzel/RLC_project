...
class Game:
    ...
    def __init__(self):
        ...
        self.p1_timer = Timer(6000, "bot")
        self.p2_timer = Timer(6000, "top")
    ...
    def set_depth(self, depth):
        """
        Sets depth of Minimax in game menu.
        (Simon Schneider, 2021)
        :param depth: integer corresponding to depth
        :return: None
        """
        self.depth = depth
    ...
    def menu_screen(self):
        ...
        menu.add.text_input('Depth : ', default=self.depth, maxchar=2, onchange=self.set_depth)
    ...
    def determine_move(self):
        ...
        if self.p2_name == "Minimax":
            self.ai_move.put(AI.minimax(self.board.copy(), Depth, inf, -inf, True, self.p2_color)[0]) # Depth can be found in settings
    ...
    def game_screen(self):
        ...
        while True:
            ...
            if self.board.turn == self.p2_color \
                ...
                t = threading.Thread(target=self.determine_move)
                t.start() # actually runs thread / algorithm
            self.lock.release()
